...
<!-- Credit to the open source from David Eck (http://math.hws.edu/eck) for the Card-Image Logic-->
...
var message;
var user;
//This sets the variable user to the users account ID number
...
//This fucntion updates the users credits.  It sends the money won or lost
// along with the users accountID to the Credit Servlet.
...
//This gives the user a warning if they try to navigate away from the page while a game is in progress
...
//If the user navigates away from the page while a game is in progress they lose the hand
     ...
     new Effect.Fade(moneyDisplay, {
        ...
        afterFinish: function() {
            ...
            new Effect.Appear(moneyDisplay, {
               duration: 0.5,
               queue: "end",
               //This adds 10 credits to the users account so if they run out of money they can keep playing
               afterFinish: function() {
                   if (money <= 0) {
                        money=10;
                   }
