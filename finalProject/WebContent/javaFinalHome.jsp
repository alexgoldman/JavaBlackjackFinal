...
//This is function highlights the selected deck and then sends information to the servlet about which deck is selected
...
<script>
<!-- This checks the session to see which deck is active -->
<%  
