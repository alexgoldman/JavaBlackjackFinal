...
public class UserFacade {
	...
	//This query checks if the user has enough credits, and if they do adds the item to their collection.
	...
	//This inserts the users information into the database
	...
	//This checks that a username is not already in use
	...
	//This checks to see if an email is already in use
	...
	//This returns the number of credits a user has
	...
	//This updates the database after the user plays a hand or makes a purchase
	...
	//This adds credits to the user account if they run out
	...
	//Checks that the users credentials are valid
	...
	//Checks all of the users purchases to see what themes they own
